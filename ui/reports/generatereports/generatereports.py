...
class SDSPropertiesWidget(QWidget):
    ...
    def setup_ui(self):
        uic.loadUi("ui/reports/generatereports/properties/sdspropertieswidget.ui", self)
...
class LabelPropertiesWidget(QWidget):
    ...
    def setup_ui(self):
        uic.loadUi("ui/reports/generatereports/properties/labelpropertieswidget.ui", self)
...
class SummaryPropertiesWidget(QWidget):
    ...
    def setup_ui(self):
        uic.loadUi("ui/reports/generatereports/properties/summarypropertieswidget.ui", self)
...
class GenerateReports(QDockWidget):
    ...
    def setup_ui(self):
        uic.loadUi('ui/reports/generatereports/generatereports.ui', self)
